...
#' @param test the test to be performed by anova (default='F')
#'
#' @return a list containing a summary of the comparison and the resulting `glm` model object
#'
#' @examples
#'
#' simA <- simulate_pan(rate=1e-3, ngenomes = 200, fn_error_rate=0, fp_error_rate=0)
...
#'
#' @export
compare_pangenomes <- function(fitA, fitB, family="Tweedie", test='F'){
