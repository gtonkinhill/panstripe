...
The classic pangenome 'U-plot' of gene frequencies. It also includes the option of providing a phylogeny to account for the underlying population structure of the genomes. Thus, genomes that are more closely related will contribute less to the frequency counts.
