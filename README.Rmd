...
By default this will plot each branch separately. It is also possible to generate a cumulative version representing the total gene gain and loss events from the route of the phylogeny.
...
The function can also take a named list as input allowing for easy comparisons between data sets
