...
calc_bootp(res$boot_reps$model.dispersion.estimate,
           res_closed$boot_reps$model.dispersion.estimate)

calc_bootp(res$boot_reps$model.xi,
           res_closed$boot_reps$model.xi)

calc_bootp(res$boot_reps$model.core.estimate,
           res_closed$boot_reps$model.core.estimate)

calc_bootp(res$boot_reps$model.dispersion.estimate*(2-res$boot_reps$model.xi),
           res_closed$boot_reps$model.dispersion.estimate*(2-res_closed$boot_reps$model.xi))
```
...
res_small_rec <- fit_tweedie(sim_small_rec$pa, sim_small_rec$tree)
res_large_rec <- fit_tweedie(sim_large_rec$pa, sim_large_rec$tree)
```
